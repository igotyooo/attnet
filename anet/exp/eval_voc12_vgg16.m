...
clearvars -except res1 path db setting;
resultPath = './results/VOC2012/Main/comp3_det_test_%s.txt';
resultTarball = sprintf( 'DET1_%s_MO%.1f_MT%s_MM%s_MNSB%d_CWM%d.tar', ...
    setting.prenet.name, ...
    ...
    setting.anetMrg1.classWiseMerging );
