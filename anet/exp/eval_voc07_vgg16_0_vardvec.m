function eval_voc07_vgg16_0_vardvec( gpu, dvecSizes )
...
anet = anet.train;
for dvs = dvecSizes,
    setting.anetDet0.directionVectorSize = dvs;
    det = Anet_niter( db, anet, ...
        setting.anetProp, ...
        setting.anetDet0, ...
        setting.anetMrg0, ...
        setting.anetDet1, ...
